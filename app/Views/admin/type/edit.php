        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?php echo route_to('adminPropertyList') ?>">لیست کلی</a>
                    <a class="collapse-item" href="<?php echo route_to('adminPropertyCreate') ?>">افزودن جدید</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="mt-4 text-right small">
                                    <?php
                                    helper('form');
                                    echo form_open(route_to('admin-property-types-update', $type['id'])); ?>
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-12 col-form-label">نام </label>
                                        <div class="col-12 col-sm-6">
                                            <?php echo form_input(['id' => 'name', 'name' => 'name', 'placeholder' => 'name', 'class' => 'form-control'], $type['name']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="description" class="col-sm-12 col-form-label">توضیحات</label>
                                        <div class="col-12 col-sm-6">
                                            <?php echo form_textarea(['id' => 'description', 'rows' => 3, 'name' => 'description', 'placeholder' => 'description', 'class' => 'form-control'], $type['description']); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12 col-sm-6">
